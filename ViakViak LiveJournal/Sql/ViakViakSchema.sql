...
exec spAddArticle 36922, N'Что в имени твоем: Дорога', N'Вашкевич, вяк, слова', N'
...
кРД - кредо card кирдык украде(нный) кордон Кордова
тРк - тарака(араб:стучать) таракан тюрк терка турок Аттатюрк
кРт - карта корыто crate корт court карате каратель картель картон карто(фель) куратор курить куртка крот
жРГ - жаргон
...
чРД - чердак черед(а)
дРч - дрочить(см также:тарака)
чРт - черта черт
тРх - труха Тархун
хРт - heart (англ:сердце от араб:тарака - стучащее)
</span><span viak="summary">
...
exec spAddArticle 43711, N'Что в имени твоем: Рот', N'Вашкевич, вяк, слова', N'
<span viak="word">Рот
РТ - рот рота артель (во)рота ритуал рутина (г)урт юрта
Рд - ряд род орда ордер рядить (про)редить редут ярд (по)рядок рад(ость) урод (к)ряду обряд наряд редька руда (п)рядь орден ординарец ординатура Рада радение
Рж - роженица рож(д)ение рожь урожай роженница рожа оружие (сна)ружи раж ружье рыжий ряженый кряж

ТР - торить торг отара тиара тур тура тара (с)трои(ть) три тра(кт) тора
дР - дар дорога дура(к) (на )одре удар драка
жР - жир жар
</span><span viak="summary">
...
exec spAddArticle 44207, N'Что в имени твоем: Двор', N'Вашкевич, бог, вяк, закон, имя, мера, оружие, слова', N'
<span viak="word">Двор
...
ДР - дыра дар дорога дура(к) одр удар драка
РД - ряд рядом род орда ордер рядить (про)редить редут ярд (по)рядок рад(ость) урод (к)ряду обряд наряд редька руда (п)рядь орден ординарец ординатура Рада радение
Рт - <a href="http://viakviak.livejournal.com/43711.html">рот</a> рота артель (во)рота ритуал рутина (г)урт юрта
тР - тор Тора (с)трана торить торг отара тиара тур тура тара (с)трои(ть) три тра(кт)
...
Представляется, что слово Двор лежит в смысловом контексте "творить", "рядом", "вокруг", "снаружи", "отличный от" и означает сотворенное пространство рядом с домом, вокруг дома.
</span><span viak="description">
Арбат - место где стоял табор
...
тра(кт) - дорога
три - число кирпичей которое в принципе необходимо для строительства: один кирпич кладется сверху на два других обеспечивая скрепление всей структуры, придавая ей крепкость и однородность.
...
юрта - круглая
ярд - <a href="http://www.beloveshkin.com/2015/07/idealnoe-sootnoshenie-talii-beder-i-vashego-zdorovya.html">длина обхвата вокруг талии нормального мужчины</a>
