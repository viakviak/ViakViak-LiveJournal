...
Мор
МР - мор море моряк мир мрамор омары мореный мурена (гла)мур Amarias Мара МУР
...
exec spAddArticle 44378, N'Что в имени твоем: Time(англ:время) - what is in the name', N'english, время, вяк, слова', N'
<span viak="word">Time(англ:время)

ТМ - time тема том томат тьма отъем тотем team
МТ - мат мата(араб:смерть) мать материя мот метка маятник муть метать (с)меять(ся) math(англ:математика)
дМ - дом демон дума Дима Адам
Мд - мода мед медаль mud(англ:грязь) мудак 
фМ - Фома Фима 
Мф - миф муфта муфтий Мефодий
</span><span viak="summary">
Слово Time(англ:время) может иметь смысл "вызывающее смерть", "размеченное", "отчитываемое маятником", "тянущееся", и связано с понятиями материи и математики
</span>
';
GO
