...
exec spAddArticle 20390, N'Прямой перевод: Smart(англ:Умный)', N' Вашкевич, вяк, перевод, слова, смерть', N'
...
КРМ - crime(англ:преступление) кромка крем карма кремль керамика корм карамель карамболь Crimea Крым Каримов "курам( насмех)" Кромвель
МРч - (с)мерчь March(англ:Март)
чРМ - Черемизов
МРг - морг морга(ть)
гРМ - грамо(та) гром греме(ть) горемы(ка)
хРМ - храм хром хоромы хрома(ть) хрум(кать)

Мор
МР - море моря(к) мир мрамор омары море(ный) муре(на) Amarias Мара
РМ - рама arm(рука) ром Romeo Рим Irma Urma армия Арамеи Арме(ния)
...
мир - человеческий, смертный, в отличии от небесного, вечного
...
ДР - дыра дар дорога дура(к) дурь одр удар драка door(англ:дверь)
РД - ряд рядом род орда ордер рядить (про)редить редут ярд (по)рядок рад(ость) урод (к)ряду обряд наряд редька руда (п)рядь орден ординарец ординатура Рада радение Родина рыдать
Рт - <a href="http://viakviak.livejournal.com/43711.html">рот</a> рота артель (во)рота ритуал рутина (г)урт юрта creator(англ:создатель) (к)арта art порт портянка порты retina(англ:сетчатка) urethra(англ:мочеиспускательный тракт)
тР - тор Тора (с)трана торить торг отара тиара тур тура тара (с)трои(ть) три тра(кт) тарака(араб:стучать) тиран торба
...
тарака(араб:стучать) - работать методично
