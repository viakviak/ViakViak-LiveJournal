...
С (З) - звук проходящий связь сжатые зубы (препятствие) в одном определённом направлении через узкое горло со свистящим звуком соединяющий в этот момент внутреннее с внешним.

</span><span viak="description">
связь - узкое соединение (вязь)
сок - выжатый, прошедший через жернова
...
МР - мир море мор мера самурай <a href="http://viakviak.livejournal.com/20390.html" target="_blank">смерть</a> mortal(англ:смертный) морфий мортира сумерки марк марка маркграф маркиз сморкать камера tumor(англ:опухоль) tomorrow(англ:завтра) шумеры Америка Самара Измир Смирна Самара Самарканд Жмеринка бром summer(англ:лето) morning(англ:утро) mourning(англ:траур)
РМ - ром ремень рамэн(яп:лагман) армия гром греметь кромка Рим Армения Германия Померания Румыния Крым <a href="http://viakviak.livejournal.com/44584.html" target="_blank">время</a> бремя румб форма фирма рама arm(англ:рука) 
...
бром - умертвляющая, токсичная жидкость.
время - умертвляющее
Германия - г-Романия, к-Романия, выход к-морю, поморье.
гром - страшный грохот, опасная стихия.
камера - опасное помещение
кромка - граница
Крым - к-Рим, выход к морю, поморье.
марка - смертельная пограничная зона; денежный знак в пограничной зоне.
маркграф - выше маркиза, владелец земли в приграничной зоне.
маркиз - владелец земли в приграничной зоне.
мера - правовая оценка вины, проступка, степень наказания вплоть до смерти.
мор - умертвляющая эпидемия.
море - смертельно опасная среда
мортира - смертоносное оружие
морфий - вызывающий сон, смерть
Померания - поморье
рама - граница
ром - усыпляющий
Самарканд - самар+канд(узб:сахар)
самурай - несущий смерть, играющий со смертью, готовый к смерти.
сморкать - болезнь
сумерки - конец (смерть) дня
фирма - от слова форма, синонимы: корпорация от слова corpus(лат:тело), организация от слова орган.
форма - ограничивающая
</span><span viak="summary">
Слово Мир лежит смысловом пространстве "ограниченный", "смертный", "опасный".
</span>
';
GO
