...
exec spAddArticle 57155, N'Префих: ЧР-/КР- - разор, разорение, разрез, разбитый, рыцарь, разворовали, разобрали, развёрнутый',  N'вяк, дом, префих, слова, тело', N'
...
РЗР - разор разорение разрушение разрешить razor(англ:бритва) resurrection(англ:воскресение)
РцР - рыцарь
...
Префиксы "ЧР-" и "КР" выражают "разор", "разорение", "разрез", "разбитый", "рыцарь", "разворовали", "разобрали", "развёрнутый"
</span><span viak="description">
...
ГЛ - угол уголь гулять глаз голос голый glue(англ:клей) Галя Гоголь
ЛГ - луг лягушка легкий лига
кЛ - укол кол колокол ключ киль куль кал клей 
Лк - лук лик ялик лейка алкать альков алкоголь
хЛ - хлюпать хлеб хохол хала халва
Лх - ольха лихо лох
...
Слово Угол находится в смысловом поле "излучина", "изгиб", "меняющий", "изменяющийся"
</span><span viak="description">
глаз - изменяющийся, выпуклый
голый - угловатый без одежды
гулять - изгибаться при ходьбе, гнуть ноги.
...
МН - money(англ:деньги) moon(англ:луна) mine(англ:мой;мина) мне мина умный мена Маня манна many(англ:много) мно(го) мнуть
НМ - немой animal(англ:животное) номер нимб
</span><span viak="summary">
Money(англ:деньги) = менять, обменивать
</span><span viak="description">
