...
СТ - остановка стоянка стоять стена сатана стоп пост поступок south(англ:юг,вниз) sit(англ:сидеть) сосать ссать сито 
ТС - тесать тоска тиски Тесла Атос
Сд - сад сидеть суд сиденье сидор седина ссадина сосуд Саид Исида
дС - досада диск доска досье dis-(англ:не-) 
зд - здание создание создатель зад зуд задание заядлый здоровье задор
дз - дозор доза 
</span><span viak="summary">
Компонента "СТ" выражает "замедление", "остановка", "установка". <a href="http://viakviak.livejournal.com/50841.html" target="_blank">Звук "Щ"</a> использующийся в замещении "СТ" имеет тот же смысл.
</span><span viak="description">
</span>
';
GO
...
exec spAddArticle 54707, N'Компонента: МТ - окруженный, окутанный, обмотанный',  N'вяк, имя, компонента, слова', N'
<span viak="component">МТ

МТ - мата(араб:умер) шахматы мать муть мыть мята мятый метка матрёшка митральеза обмотка мотать Митрий мат - матрац мытарь метан mittens(англ:рукавицы)
ТМ - тема томить туман темень там тамтам томный томограф темечко Тюмень атаман
Мд - мудрый медресе мадера мода мёд mud(англ:грязь) middle(англ:середина)
дМ - дом дым Дмитрий дума демпфер
Мф - muffin(англ:кекс) муфтий миф Мефистофель
Фм - fume(англ:дым) Фома famous(англ:известный)
</span><span viak="summary">
Компонента МТ выражает "окруженный", "окутанный", "обмотанный".
</span><span viak="description">
мата(араб:умер) - удушен,не дышит
матрёшка - мать, вложенная в другие
мать - окруженная детьми
...
exec spAddArticle 54989, N'Компонента: ГН - изогнутая, согнутый, извивающийся, гибкий, подчиненный, свернутый, выдутый',
 N'вяк, закон, имя, книга, компонента, слова, тело, титул, этнос', N'
<span viak="component">ГН

ГН - гнутый изогнутый гнать гон огонь гиена каган регент гнев гной гнездо гнёт гнида гнильё гном гнус Гондурас Гонконг Гиндукуш Гинея Аргентина Ургенч гунны
НГ - нога нега нагая нагайка ангар Негус Англия негр Нигерия награда ноготь
кН - книга князь окно кино кон конь куница Каин canine(англ:собачий,клык) книксен knight(англ:всадник,кнехт) кнопка canopy(англ:навес) канд(тюрк:сахар) конституция Канада conquest(англ:завоевание) контора кантор
Нк - nook(англ:угол,закоулок) нектар Анкара Инки Николай наказ
хН - хан кухня 
Нх - нюх нахал
</span><span viak="summary">
Компонента "ГН" выражает "изогнутая", "согнутый", "извивающийся", "гибкий", "подчиненный", "свернутый", "выдутый", "свитый".
</span><span viak="description">
...
knight(англ:всадник,кнехт) - подчиненный, из свиты, витязь
...
закон - наказ, свиток, кон, конституция, домашние/местные правила для подчиненных(кон+каса(рус:дом,хаза))
изогнутый - выгнутый
инок - подчиненный
каган - согнутый, сгибающийся, подчиненный, из свиты
...
регент - подчиненный, из свиты
хан - подчиненный, из свиты
</span>
';
GO
/*
