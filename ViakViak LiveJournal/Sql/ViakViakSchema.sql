...
exec spAddArticle 49834, N'Компонента: П', N'2x, вяк, компонента, слова', N'
...
exec spAddArticle 50020, N'Компонента: Л',  N'вяк, компонента, слова', N'
...
exec spAddArticle 50418, N'Компонента: МР',  N'вяк, компонента, слова', N'
...
exec spAddArticle 50841, N'Переход: Щ - С',  N'вяк, переход, слова', N'
...
тощий - доска
щебень - щепа цепкий
щека - cheek(англ:щека)
щенок - сынок
щепоть - сыпать
щука - сука
щупать - цапать
щериться - сраться
щетина - седина(?), останки бороды(?)
щетка - сетка(?) садок(?)
щирий(укр:искренний) - сирый(?)
хрущ - хруст
</span><span viak="summary">
Выглядит так, что существует переход "Щ - С" с сохранением смысла слов. Похоже, что если "Щ" находится в середине слова, то "Щ" трансформируется в "СТ", реже "СК". Похоже, что мы видим следы немецкого "окультуривания" русского языка.
</span>
';
GO
