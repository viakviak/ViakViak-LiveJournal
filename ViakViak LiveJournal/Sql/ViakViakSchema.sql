...
Слово "Великий" читается наоборот "аки лев". Также заменяя "В" на "Б", мы видим, что слово "Великий" производится от "Бал" (голова, главный"): балик ("Баликий"). Проецируя на животных, мы получаем:
