...
exec spAddArticle 56395, N'Компонента: РЗ/РС - разрезать, делать просвет, раскрывать, раздвигать',  N'вяк, компонента, слова', N'
<span viak="component">Компонента: РЗ/РС

РС - рас- роса рис раис рассвет
СР - сор срать серый суровый сирый
Рц - рыцарь рцы
цР - царь цирюльник цирк циркуль церебральный церемония
РЗ - раз- раз резать роза риза
ЗР - зоря зреть зирвак зарок козырь зырить узреть зря Азербайджан
щР - ощерить ящер 
Рш - решение Russia(англ:Россия) rush(англ:спешка)
шР - шар широкий шариат кошер
...
чР - чары чирей чардаш череда чарка
</span><span viak="summary">
Компонента: РЗ/РС выражает "разрезать", "делать просвет", "раскрывать", "раздвигать".
</span><span viak="description">
</span>
';
GO
