...
colon(англ:кишка) - глубоко в животе, орган с дырой
gallows(англ:виселица) - для отправления в другой (далекий) мир
leg(англ:нога) - нога, голень ходить далеко
галео(н) - пустой, для дальнего плавания
гале(ра) - для дальнего плавания
гальюн - отхожее, дальнее место
