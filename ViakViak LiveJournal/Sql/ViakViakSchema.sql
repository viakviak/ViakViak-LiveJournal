...
ГН - гнутый изогнутый гнать гон огонь гиена каган регент гнев гной гнездо гнёт гнида гнильё гном гнус гинея Гондурас Гонконг Гиндукуш Гана Аргентина Ургенч гунны гуано вагон вагина Иоганн Геннадий гандон генерал
НГ - нога нега нагая нагайка ангар Негус Англия негр Нигерия награда ноготь young(англ:молодой)
кН - книга князь окно кино кон конь куница Каин canine(англ:собачий,клык) книксен knight(англ:всадник,кнехт) кнопка canopy(англ:навес) канд(тюрк:сахар) конституция Канада conquest(англ:завоевание) контора кантор king(англ:король)
...
Компонента "ГН" выражает "изогнутая", "согнутый", "извивающийся", "гибкий", "подчиненный", "свернутый", "выдутый", "важный", "свитый", "юный".
</span><span viak="description">
...
Англия - подчиненная
вагина - извилистая
вагон - виляет, может ехать по извилистой дороге
важный - надутый
гавно - навитое
гандон - выдуваемый
ген - изогнутая ДНК
