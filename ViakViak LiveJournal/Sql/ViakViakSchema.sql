...
щщщ - тихо! "stop talking"(англ:"прекратите разговаривать")
</span>
';
GO
...
МТ - мата(араб:умер) шахматы мать муть мыть мята мятый метка матрёшка митральеза обмотка мотать Митрий мат матрац мытарь метан mittens(англ:рукавицы) метать комета, митра метр мэтр материя meat(англ:мясо,мякоть,суть) мять маятник
...
Мф - muffin(англ:кекс) муфтий миф Мефистофель муфта muff(англ:муфта) амфора Мефодий амфибия амфитеатр мафия
Фм - fume(англ:дым) Фома famous(англ:известный) family(англ:семья) feminine(англ:женский) female(англ:матка) Фома
- Мв - move(англ:движение) омовение умывание
- вМ - вымя вам vomit(англ:рвота)
- - Мб - mob(англ:толпа,банда,мафия) mobile(англ:подвижный) мебель амбар амёба амбал амёба
- - Бм - объем бомба бумеранг бум бумага beam(англ:луч,балка,щирина) бомж bum(англ:бомж)
- - - Пм - помощь пума
- - - мП - ампула empale(англ:пронзать,обносить частоколом) империя emporium(англ:рынок) mop(англ:швабра,космы)
</span><span viak="summary">
Компонента МТ выражает "окруженный", "окутанный", "обмотанный", "обернутый", "покрывающий", "окружение", "обволакивать", "объединять", "окружать", "тесно", "ограниченная подвижность", "объем", "общество", "обмазанный", "липкий".
</span><span viak="description">
