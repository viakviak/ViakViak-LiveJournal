...
ПРС - персона пирс поросенок просить просо Paris(англ:Париж) прииск Пруссия process(англ:процесс)
...
Представляется, что слово Персона может быть тесно связано со словом "Просить" в смысле "проситель" дворянского титула, например, которыми могли быть только дворяне, т.е. "всадники".
