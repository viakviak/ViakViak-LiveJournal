...
exec spAddArticle 54707, N'Компонента: МТ - окруженный, окутанный, обмотанный, вложенный, покрывающий',  N'вяк, имя, компонента, слова, смерть', N'
...
ТМ - тема томить туман темень темя там тамтам томный томограф Тюмень атаман
...
Компонента МТ выражает "окруженный", "окутанный", "обмотанный", "обернутый", "вложенный", "покрывающий", "окружение", "общество", "обмазанный", "липкий".
</span><span viak="description">
...
атаман - окруженный, уважаемый, лидер общества
...
мотать - укутывать
мудрый - окруженный, уважаемый в обществе
мудрец - окончивший медресе, (мд+рс) разорвавший своё окружение, уединенный
...
кН - книга князь окно кино кон конь куница Каин canine(англ:собачий,клык) книксен knight(англ:всадник,кнехт) кнопка canopy(англ:навес) канд(тюрк:сахар) конституция Канада conquest(англ:завоевание) контора кантор king(англ:король) конунг Конго каннибал 
