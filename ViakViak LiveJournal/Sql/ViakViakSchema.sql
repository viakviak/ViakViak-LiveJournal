...
пирог - "сгреблено, сметено" в него
...
Слово Silver видится как калька слова Серебро при переходах <a href="http://viakviak.livejournal.com/39647.html">Р - Л</a> и <a href="http://viakviak.livejournal.com/33634.html">Б - В</a>.
</span><span viak="summary">
...
Иегова - богъ (Прочитанное наоборот, с переходом в-б)
...
Возможно, что слово Книга имеет отношение к слову KiNG-Чинг(изид) с <a href="http://viakviak.livejournal.com/29208.html" target="_blank">переходом К(Q) - Ч (cм: Четыре - Quatro)</a>. Тогда, считая слово Книга основным, а Чинг(из) или КиНГ производным, получаем, что Чингизиды(короли, князья) - это люди Книги.
</span><span viak="reference">
