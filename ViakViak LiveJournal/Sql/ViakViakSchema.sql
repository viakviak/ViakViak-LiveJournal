...
exec spAddArticle 56395, N'Компонента: РЗ/РС - разрезать, делать просвет, раскрывать, раздвигать',  N'вяк, компонента, слова, тело', N'
<span viak="component">Компонента: РЗ/РС

РС - рас- роса рис раис рассвет крест просо Россия бросать trust(англ:доверие) береста просто брус парус красный красота кираса horse(англ:лошадь) корысть контраст конгресс крыса расстояние grass(англ:трава) grace(англ:грация)
СР - сор срать серый суровый сирый сарынь сердце середина среда средство сарацин Саратов сорок срок сорока срака сурок Саркел сироп сарай серьга
Рц - рыцарь рцы курица крица корица
цР - царь церковь цирюльник цирк циркуль церебральный церемония
РЗ - раз- раз резать роза риза breeze(англ:ветерок) круз бразды резон паразит crazy(англ:псих) коррозия мороз rise(англ:восход,подъем) чрезвычайный через разряд
ЗР - зоря зреть зирвак зарок козырь зырить узреть зрячий зрачок зря Азербайджан зерно зря позор базар лазер узурпация зирвак
Рщ = роща прыщ дрыщь 
щР - ощерить ящер пещера
Рш - решение Russia(англ:Россия) rush(англ:спешка) крошка порошок крыша 
шР - шар широкий шариат кошер shred(англ:кромсать) shark(англ:акула)
Рч - речь ручей врач арча кручина карачки Карачи Керчь курчавый парча treacherous(англ:коварный) preach(англ:проповедовать) approach(англ:подход) roach(англ:таракан) reach(англ:достигать) порча torch(англ:факел)
чР - чары чирей чардаш череда чарка черевички
</span><span viak="summary">
Компонента: РЗ/РС выражает "разрезать", "делать просвет", "раскрывать", "раздвигать", "открытие", "проступать", "проходить насквозь", "торчащий из".
</span><span viak="description">
...
конгресс - исходящий из канона, проявление канона, красота канона
контраст - резкое различие от канона
корысть - вылезающая
